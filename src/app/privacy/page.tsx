...
export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <P>
        Мы можем собирать следующие данные: имя, контактный телефон, email-адрес, 
        а также информацию об использовании сайта с помощью cookies.
      </P>
      
      <H2 className="mt-6 mb-4">3. Использование cookies</H2>
      <P>
        Cookies — это небольшие текстовые файлы, которые сохраняются на вашем 
        устройстве при посещении сайта. Они помогают нам анализировать трафик 
        и улучшать работу сайта.
      </P>
