          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-primary-light rounded-full flex items-center justify-center hover:bg-primary transition-colors hover:text-white"
                >
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-secondary-light rounded-full flex items-center justify-center hover:bg-secondary transition-colors hover:text-white"
                >
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-accent-light rounded-full flex items-center justify-center hover:bg-accent transition-colors hover:text-white"
                >
